...
import org.opencart.page.LoginPage;
...
public class LoginPageStepDef {
    ...
    public void i_have_entered_a_valid_username_and_password() {
        loginPage.enterEmail("raghuveermh30@gmail.com");
        loginPage.enterPassword(" R@ghumh3017");
    }
    ...
    public void i_should_see_an_error_message_indicating(String errorMessage) {
        ...
        wait.until(d -> d.findElement(By.cssSelector(".alert.alert-danger.alert-dismissible")).isDisplayed());
        Assert.assertTrue(driver.findElement(By.cssSelector(".alert.alert-danger.alert-dismissible")).isDisplayed());
    }
